% Compile from this directory with: pdflatex project_8.tex (twice).
...
\textbf{Course foundations:} Lectures 4 and 8; Exercises 1 and 4.
...
The three family parameter sets and compatible parameterized IK will be supplied
separately. Use Lecture 8 and Exercise 4 for chart construction; the course
reference data can check the original iiwa member only.
